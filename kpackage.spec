...
Source0  : https://download.kde.org/stable/frameworks/5.70/kpackage-5.70.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.70/kpackage-5.70.0.tar.xz.sig
...
%prep
%setup -q -n kpackage-5.70.0
cd %{_builddir}/kpackage-5.70.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589214236
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpackage-5.70.0/COPYING %{buildroot}/usr/share/package-licenses/kpackage/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kpackage-5.70.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kpackage/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/kpackage-5.70.0/src/kpackage/COPYING.LIB %{buildroot}/usr/share/package-licenses/kpackage/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Package.so.5.70.0
