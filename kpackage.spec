...
Version  : 5.90.0
Release  : 302
URL      : file:///aot/build/clearlinux/packages/kpackage/kpackage-v5.90.0.tar.gz
Source0  : file:///aot/build/clearlinux/packages/kpackage/kpackage-v5.90.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643420081
mkdir -p clr-build
pushd clr-build
