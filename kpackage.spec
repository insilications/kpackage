...
Source1  : https://download.kde.org/stable/frameworks/5.90/kpackage-5.90.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642011927
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpackage-5.90.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kpackage/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kpackage-5.90.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kpackage/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kpackage-5.90.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kpackage/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
