...
Source0  : https://download.kde.org/stable/frameworks/5.87/kpackage-5.87.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.87/kpackage-5.87.0.tar.xz.sig
...
%prep
%setup -q -n kpackage-5.87.0
cd %{_builddir}/kpackage-5.87.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634427121
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpackage-5.87.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kpackage/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kpackage-5.87.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kpackage/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Package.so.5.87.0
